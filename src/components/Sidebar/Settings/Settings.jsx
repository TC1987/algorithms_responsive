	...
	<div className={props.listContainer}>
		...
		<ul className={props.list}>
			<li className={styles.label}>
				Speed: <span className={props.bold}>{props.speed}ms</span>
			</li>
			<li>
				<input
					type="range"
			...
			<li className={styles.label}>
				# of Bars: <span className={props.bold}>{props.barCount}</span>
			</li>
			<li>
				<input
					type="range"
			...
			<li className={styles.label}>
				Min Height: <span className={props.bold}>{props.minHeight}</span>
			</li>
			<li>
				<input
					type="range"
			...
			<li className={styles.label}>
				Max Height: <span className={props.bold}>{props.maxHeight}</span>
			</li>
			<li>
				<input
					type="range"
